...
<html lang="en">
  <head>
    ...
    <!-- Google tag (gtag.js) -->
      <script async src="https://www.googletagmanager.com/gtag/js?id=AW-16702945092"></script>
      <script>
      ...
      <div class="inside-container service-section">
        ...
        <div class="row service-detail">
            ...
            <div class="col-lg-4">
              ...
              <p class="service-desc">Explore a variety of classes tailored for all levels, from beginner to advanced, and start your journey toward a healthier, mindful life.</p>
            </div>
          <div class="col-lg-4">
            <svg version="1.1" class="service-detail-img" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
               viewBox="0 0 90 65" style="enable-background:new 0 0 90 65;" xml:space="preserve">
            ...
            <p class="service-desc">Experience guided yoga routines designed to improve flexibility, strength, and inner calm. Perfect for energizing your body and soothing your mind.</p>
          </div>
          <div class="col-lg-4">
            <svg version="1.1" class="service-detail-img" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
               viewBox="0 0 90 65" style="enable-background:new 0 0 90 65;" xml:space="preserve">
            ...
            <p class="service-desc">Take part in our exciting yoga challenge and push your limits. Enhance your practice with daily routines that build strength, flexibility, and focus.</p>
          </div>
        </div>
      </div>
      <!--Class Yoga Center-->
          ...
          <div class="col-lg-6 best-class-club-desc">
            <div class="row">
              ...
              <div class="col-lg-8 detail-col-club">
                ...
                <p>Join our carefully designed yoga sessions that cater to all skill levels, helping you build strength, flexibility, and inner peace through mindful practice.</p>
                <ul>
                  <li>Experience deep relaxation and mental clarity</li>
                  <li>Enhance your physical and emotional well-being</li>
                  <li>Personalized guidance for beginners and advanced practitioners</li>
                </ul>
                <p>Whether you're new to yoga or an experienced practitioner, our classes will guide you toward a healthier, more balanced life.</p>
      ...
      <div class="advantages-section">
        <div class="row sections-detail">
          <div class="col-12">
            ...
            <p class="section-title-desc">Discover how yoga improves flexibility, strengthens your body, reduces stress, and brings harmony to both mind and soul.</p>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="advantages-detail-soul">
                  ...
                  <p class="advantages-detail-desc">Yoga helps you achieve inner peace and mental clarity, creating a harmonious balance between mind and soul.</p>
                </div> 
              </div>              
            </div>
            <div class="row">
              <div class="col-12">
                <div class="advantages-detail-health">
                  ...
                  <p class="advantages-detail-desc">Practicing yoga regularly enhances overall physical health, boosts immunity, and promotes a well-balanced lifestyle.</p>
                </div>
              </div>              
            </div>
            <div class="row">
              <div class="col-12">
                <div class="advantages-detail-relax">
                  ...
                  <p class="advantages-detail-desc">Yoga provides deep relaxation, helping you recharge both mentally and physically, leaving you refreshed and revitalized.</p>
                </div>
              </div>              
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="advantages-detail-energy">
                  ...
                  <p class="advantages-detail-desc">Experience a rejuvenating journey that harmonizes your body and mind through restorative yoga practices.</p>
                </div>
              </div>              
            </div>
            <div class="row">
              <div class="col-12">
                <div class="advantages-detail-mind">
                  ...
                  <p class="advantages-detail-desc">Recenter your thoughts and find mental clarity through yoga that calms the mind and renews the spirit.</p>
                </div>
              </div>              
            </div>
            <div class="row">
              <div class="col-12">
                <div class="advantages-detail-meditat">
                  ...
                  <p class="advantages-detail-desc">Join our meditation classes to deepen your practice and enhance your inner peace and mindfulness.</p>
                </div>
              </div>              
            </div>
          </div>
      ...
      <div class="yogaPlace-section">
        <div class="row sections-detail">
          <div class="col-12">
            ...
            <p class="section-title-desc">Join us for yoga classes designed to balance the body, calm the mind, and renew your energy in a supportive environment.</p>
          </div>
        </div>
        <div class="inside-container ">
          <div class="row yogaPlace-col">
            <div class="col-lg-3">
              ...
              <p class="yogaPlace-desc">Kundalini Yoga combines breathwork, meditation, and physical postures to awaken the energy within and achieve spiritual elevation.</p>
            </div>
            <div class="col-lg-3">
              <div class="yogaPlace-img">
              ...
              <p class="yogaPlace-desc">Basic Yoga focuses on simple postures and breathing techniques, making it perfect for beginners looking to enhance flexibility and mindfulness.</p>
            </div>
            <div class="col-lg-3">
              <div class="yogaPlace-img">
              ...
              <p class="yogaPlace-desc">Iyengar Yoga emphasizes precision and alignment in postures, using props to aid practice and increase stability.</p>
            </div>
            <div class="col-lg-3">
              <div class="yogaPlace-img">
              ...
              <p class="yogaPlace-desc">Advanced Yoga is designed for experienced practitioners, featuring complex poses that challenge both strength and flexibility.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="inside-container contact-section">
        <div class="row sections-detail">
          <div class="col-12">
            ...
            <p class="section-title-desc">We strive for clarity in our communication and scheduling.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
            <div class="appointment">
              ...
              <p class="appointment-desc">Fill out the form below to book your session and join us for an enriching yoga experience.</p>
              <form action="#" class="appointment-form" onsubmit="return handleFormSubmit(event)">
                <div class="row">
                  ...
                  <div class="col-lg-6 box-select appointment-form-col-right">
                    <select name="class" class="form-control appointment-form-input">
                      <option value="choose-class">Select Yoga Class</option>
                      <option value="kundalini">Kundalini Yoga</option>
                      <option value="basic">Basic Yoga</option>
                      <option value="iyengar">Iyengar Yoga</option>
                      <option value="advanced">Advanced Yoga</option>
                    </select>
                  </div>
                  <div class="col-lg-6 appointment-form-col-left">
                    <input type="tel" class="form-control appointment-form-input" placeholder="Phone Number*" required="" maxlength="10">
                  </div>
                  <div class="col-lg-6 appointment-form-col-right">
                    <input type="email" class="form-control appointment-form-input" placeholder="Email Address*" required="">
                  </div>
                  <div class="col-12 appointment-form-col-left">
                    <textarea class="form-control appointment-form-text" id="exampleFormControlTextarea1" rows="3" placeholder="Additional Message (Optional)"></textarea>
                  </div>
                  <div class="col-12 appointment-form-col-right">
                    <button type="submit" class="appointment-form-btn">Book Your Appointment</button>                              
                  </div>
                </div>
              </form>
      ...
      <div class="trainer-section">
        <div class="row sections-detail">
          <div class="col-12">
            ...
            <p class="section-title-desc">Our dedicated trainers are here to guide you on your yoga journey.</p>
          </div>
        </div>
        <div class="inside-container">
          <div class="row trainer-col">
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="img/fig-nelson.jpg" class="trainer-in-img" alt="Fig Nelson">
              </div>              
              <a href="#"><h3 class="trainer-title">Fig Nelson</h3></a>
              <p class="trainer-desc">Yoga Instructor</p>
            </div>
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="img/jason-response.jpg" class="trainer-in-img" alt="Jason Response">
              </div>
              <a href="#"><h3 class="trainer-title">Jason Response</h3></a>
              <p class="trainer-desc">Basic Yoga Specialist</p>
            </div>
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="img/eric-widget.jpg" class="trainer-in-img" alt="Eric Widget">
              </div>
              <a href="#"><h3 class="trainer-title">Eric Widget</h3></a>
              <p class="trainer-desc">Kundalini Yoga Expert</p>
            </div>
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="img/lance-begrol.jpg" class="trainer-in-img" alt="Lance Bogrol">
              </div>
              <a href="#"><h3 class="trainer-title">Lance Bogrol</h3></a>
              <p class="trainer-desc">Nutrition & Healthy Recipes</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="inside-container join-us-section">
        <div class="row sections-detail">
          <div class="col-12">
            ...
            <p class="section-title-desc">We're here to help you with any questions you may have.</p>
          </div>
        </div>
        <div class="row">
          <!-- <div class="col-12">
...
<!--             <p class="join-us-call">or Call: <a href="tel:+1-555-123-4567" class="join-us-phone-nr">+1-555-123-4567</a></p> -->
      ...
      <footer class="footer">
        <div class="copyright">
          <div class="inside-container">
            <div class="row">
              <div class="col-md-6 order-2 order-md-12" style="text-align:center; margin: auto;">
                <p style="text-align:center;">&copy; 2024 All Rights Reserved. Created by <a href="index.php" class="created-by">Yoga Center</a></p>
              </div>
